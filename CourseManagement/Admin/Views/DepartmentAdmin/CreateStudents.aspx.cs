...
namespace Admin.Views.DepartmentAdmin
{
    public partial class AddStudents : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.degreeProgram.DataSource = dal.GetAllDegreePrograms();
        }
        ...
        protected void createStudent_Click(object sender, EventArgs e)
        {
            ...
            var dob = DateTime.Parse(this.birthday.Text); PersonalStuff info = new PersonalStuff(firstName,middleInitial,lastName,id,phone, sex, dob, race, email, ssn);
            adminDal.CreateStudent(info, this.studentID.Text, this.degreeProgram.SelectedValue);
